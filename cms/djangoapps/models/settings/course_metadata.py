...
class CourseMetadata(object):
    ...
    def validate_and_update_from_json(cls, descriptor, jsondict, user, filter_tabs=True):
        ...
        if (
            ...
            cls._has_requested_proctoring_provider_changed(descriptor.proctoring_provider, proctoring_provider_model) and
    ...
    def _has_requested_proctoring_provider_changed(current_provider, requested_provider):
        ...
        """
        if current_provider is None or requested_provider is None:
            return False
        else:
